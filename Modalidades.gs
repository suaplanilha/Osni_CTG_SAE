...
const MODALIDADES = Object.freeze([
  ...
  { id_modalidade: 'truco', nome_modalidade: 'Truco de Amostra', placar_min: 0, placar_max: 2, permite_empate: false, formato: 'MELHOR_DE_3', regras_pontos: 'Melhor de três quedas; primeiro a duas vitórias.' },
